...
input double stop_loss_multiplier = 1.0;   // Stop loss multiplier
...
void OnTick()
{
    ...
    else
    {
        ...
        if (StringFind(_Symbol, CRASH_SYMBOL) != -1 && upTrendArrow[0] != 1.7976931348623157e+308){
    ...
    else if (StringFind(_Symbol, BOOM_SYMBOL) != -1 && downTrendArrow[0] != 1.7976931348623157e+308)
    {
