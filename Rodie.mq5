...
void OnTick()
{
    ...
    else
    {
        ...
        if (StringFind(_Symbol, VOLATILITY_SYMBOL) != -1 && upTrendArrow[0] != 1.7976931348623157e+308){
    ...
    else if (StringFind(_Symbol, VOLATILITY_SYMBOL) != -1 && downTrendArrow[0] != 1.7976931348623157e+308)
    {
